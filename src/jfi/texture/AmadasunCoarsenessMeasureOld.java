 ...
 */
public class AmadasunCoarsenessMeasureOld implements TextureMeasure<Double> {
     ...
     */
    public AmadasunCoarsenessMeasureOld() {
     ...
     */
    public AmadasunCoarsenessMeasureOld(float distance, float greyLevels) {
