...
import jfi.texture.AmadasunCoarsenessMeasureOld;
import jfi.texture.CorrelationCoarsenessMeasureOld;
 ...
 */
public class FuzzyTextureFactoryOld {
    ...
    public static class FunctionFactory {
        ...
        private static TextureMembershipFunction getCoarsenessAmadasunInstance() {
            ...
            TextureMeasure measure = new AmadasunCoarsenessMeasureOld();
        ...
        private static TextureMembershipFunction getCoarsenessCorrelationInstance() {
            ...
            PolynomialFunction1D mfunction = new PolynomialFunction1DAlphaBeta(coeficients, alpha, beta);
            TextureMeasure measure = new CorrelationCoarsenessMeasureOld();
            return new TextureMembershipFunction(mfunction, measure);
        }
        ...
        private static TextureMembershipFunction getCoarsenessAmadasunCorrelationInstance() {
            ...
            TextureMeasure measure1 = new AmadasunCoarsenessMeasureOld();
            TextureMeasure measure2 = new CorrelationCoarsenessMeasureOld();
